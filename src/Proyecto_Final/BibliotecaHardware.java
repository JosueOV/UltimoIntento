 ...
 */
public class BibliotecaHardware extends javax.swing.JFrame {

    /**
     * Creates new form Biblioteca
     */
    public BibliotecaHardware() {
        initComponents();
        setLocationRelativeTo(null);
         setIconImage(new ImageIcon(getClass().getResource("/Imagenes/STEAMLOGO1.png")).getImage());
    }
    private BibliotecaHardware getFrame(){
    return this;
}
    /**
    ...
    private void initComponents() {
        ...
        getContentPane().add(jToolBar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 30, 1010, 220));
        ...
        getContentPane().add(jToolBar2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 460, 1010, 210));

        jButton14.setBackground(new java.awt.Color(190, 247, 253));
        jButton14.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jButton14.setForeground(new java.awt.Color(15, 57, 98));
        ...
        getContentPane().add(jButton14, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 320, -1, -1));

        jButton6.setBackground(new java.awt.Color(190, 247, 253));
        jButton6.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jButton6.setForeground(new java.awt.Color(5, 57, 98));
        ...
        getContentPane().add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 320, -1, -1));

        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/steam-wallpapers-30778-510619 (1).jpg"))); // NOI18N
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 20, 1010, 650));
        getContentPane().add(jButton16, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 260, -1, 10));
    ...
    BibliotecaHardware s = new BibliotecaHardware();
        s.show();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BibliotecaHardware.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BibliotecaHardware().setVisible(true);
            }
        });
    }
